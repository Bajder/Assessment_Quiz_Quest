...
And will then have to try to answer. If you answer incorrectly, you will be told the correct answer before you move on
Remember -
...
You may use a calculator, or, for an extra challenge - try without!
...
number_of_questions = int_check(
    f"How many questions would you like, {user_name}? Press <enter> to start infinite mode ")
...
while questions_answered < number_of_questions:
    ...
    type_of_question = string_checker("Choose a question type! (Triangle (T), Point (P), or Quadrilateral (Q)): ",
                                      question_types)
    if mode == "infinite":
        number_of_questions += 1
    ...
    if type_of_question == "xxx":
        break
    elif type_of_question == "triangle":
        ...
        while True:
            try:
                user_answer = int(input(
                    f'If a triangles internal angles add up to 180 degrees, and the first to degrees are {angle_one} and {angle_two}, what is the value of the third angle? '))
        ...
        while True:
            try:
                user_answer = int(input(
                    f'If the angles around a point add up to 180 degrees, and you know one angle is {angle_one}, what is the value of the adjacent angle? '))
        ...
        while True:
            try:
                user_answer = int(input(
                    f'You have a quadrilateral sitting in front of you. You know three of the angles: {angle_one}, {angle_two}, {angle_three}, \t'
